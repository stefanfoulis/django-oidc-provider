...
class JsonMultiSelectModelField(models.Field):
    ...
    def deconstruct(self):
        ...
        # We simplify the Field for django migrations. It does not even need
        # to know that this is a custom field or what the choices are. To django
        # migrations this is just a TextField
